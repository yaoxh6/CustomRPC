...
const (
	...
	grpcPackage    = protogen.GoImportPath("google.golang.org/plugin")
	codesPackage   = protogen.GoImportPath("google.golang.org/plugin/codes")
	statusPackage  = protogen.GoImportPath("google.golang.org/plugin/status")
)
...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	g.P("// versions:")
	g.P("// - protoc-gen-go-plugin v", version)
...
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile) {
	...
	g.P("// is compatible with the plugin package it is being compiled against.")
...
func genService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service) {
	...
	g.P("//")
	g.P("// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/plugin/?tab=doc#ClientConn.NewStream.")
