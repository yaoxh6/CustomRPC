...
#include "examples/helloworld/helloworld/helloworld.pb.h"
...
static ::_pb::Metadata file_level_metadata_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto[2];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto = nullptr;

const uint32_t TableStruct_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n/examples/helloworld/helloworld/hellowo"
  "rld.proto\022\nhelloworld\"\034\n\014HelloRequest\022\014\n"
  "\004name\030\001 \001(\t\"\035\n\nHelloReply\022\017\n\007message\030\001 \001"
  "(\t2I\n\007Greeter\022>\n\010SayHello\022\030.helloworld.H"
  "elloRequest\032\026.helloworld.HelloReply\"\000B9\n"
  "\035io.plugin.examples.helloworldB\017HelloWor"
  "ldProtoP\001Z\005./;pbb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto = {
    false, false, 264, descriptor_table_protodef_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto,
    "examples/helloworld/helloworld/helloworld.proto",
    &descriptor_table_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto_once, nullptr, 0, 2,
    schemas, file_default_instances, TableStruct_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto::offsets,
    file_level_metadata_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto, file_level_enum_descriptors_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto,
    file_level_service_descriptors_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto_getter() {
  return &descriptor_table_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto(&descriptor_table_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto);
namespace helloworld {
...
::PROTOBUF_NAMESPACE_ID::Metadata HelloRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto_getter, &descriptor_table_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto_once,
      file_level_metadata_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata HelloReply::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto_getter, &descriptor_table_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto_once,
      file_level_metadata_examples_2fhelloworld_2fhelloworld_2fhelloworld_2eproto[1]);
}
